...
namespace EasyRpc.AspNetCore.EndPoints
{
    ...
    public class NamingConventions
    {
        ...
        public Func<Type, IEnumerable<string>> RouteNameGenerator
        {
            ...
            set => _routeNameGenerator = value ?? 
                                         throw new ArgumentNullException(nameof(RouteNameGenerator));
        }
        ...
        public Func<MethodInfo, string> MethodNameGenerator
        {
            ...
            set => _methodNameGenerator = value ?? 
                                          throw new ArgumentNullException(nameof(MethodNameGenerator));
        }
